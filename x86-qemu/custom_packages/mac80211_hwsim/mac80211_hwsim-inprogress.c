...
//	.id = GENL_ID_GENERATE,  GENL_ID_GENERATE deprecated and .id field no longer needs to be filled in
	.hdrsize = 0,
	.name = "MAC80211_HWSIM",
	.version = 1,
...
//		goto nla_put_failure;
	...
	if (nla_put_u64_64bit(skb, HWSIM_ATTR_COOKIE, (unsigned long) my_skb))
		goto nla_put_failure;
...
static int __init init_mac80211_hwsim(void)
{
	...
	for (i = 0; i < radios; i++) {
		...
		for (band = IEEE80211_CHAN_2GHZ; band < IEEE80211_NUM_BANDS; band++) {
