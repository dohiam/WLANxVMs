...
########################################################################################
get_client_name
cmd_server "./tools/bcaster/bin/Debug/bcaster"
...
sleep 1
cmd_ap "./start_hwsim0"
cmd_ap "tcpdump Space -i Space hwsim0 Space -w Space cap1.cap &"
cmd_ap "./start_ap"
...
cmd_client2 ""
sleep 1
cmd_client1 "./ci Space o"
sleep 1
cmd_client2 "tcpdump Space -i Space hwsim0 Space -w Space cap2.cap &"
sleep 1
